        ...
        content: [
            {
                ...
                text: "Welcome to My Trusted Prop. We are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website."
            },
            {
    ...
    terms: {
        ...
        content: [
            ...
            },
            {
                ...
                text: "The content on our website, including text, graphics, logos, and images, is the property of My Trusted Prop and is protected by copyright and other intellectual property laws."
            },
            {
            ...
            },
            {
                ...
                text: "My Trusted Prop will not be liable for any direct, indirect, incidental, special, or consequential damages resulting from the use or inability to use our website."
            }
        ]
    },
    disclaimer: {
        ...
        content: [
            {
                ...
                text: "The information provided on My Trusted Prop is for educational and informational purposes only. It is not intended as, and shall not be understood or construed as, financial advice. We are not attorneys, accountants, or financial advisors, nor are we holding ourselves out to be."
            },
            {
        ...
        content: [
            {
                ...
                text: "By accessing and using My Trusted Prop, you accept and agree to be bound by the terms and provision of this agreement. In addition, when using this website's particular services, you shall be subject to any posted guidelines or rules applicable to such services."
            },
            {
                heading: "2. Description of Service",
                text: "My Trusted Prop provides users with access to a rich collection of resources, including but not limited to, prop firm reviews, comparison tools, and educational content. You understand and agree that the Service is provided 'AS-IS' and that My Trusted Prop assumes no responsibility for the timeliness, deletion, mis-delivery or failure to store any user communications or personalization settings."
            },
            {
    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content={`Read the ${title} of My Trusted Prop.`} />
            </Helmet>
